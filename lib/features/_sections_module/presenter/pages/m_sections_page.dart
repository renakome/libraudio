...
class MSectionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return coreController.builder(builder: (context, coreData) {
                      ...
                      children: [
                          ...
                          builder: (context, data) {
                            ...
                            if (data.items.isEmpty) {
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  color: context.themeData.colorScheme.surfaceContainerHighest.withValues(alpha: 0.3),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      context.localization.emptyLibraryDescription,
                                      style: context.themeData.textTheme.bodyMedium?.copyWith(
                                        color: context.themeData.colorScheme.onSurface.withValues(alpha: 0.5),
                                      ),
                        ...
                        if (coreData.offlineMode)
                          Container(
                            ...
                            padding: const EdgeInsets.all(24),
                            decoration: BoxDecoration(
                              color: context.themeData.colorScheme.surfaceContainerHighest.withValues(alpha: 0.4),
                              borderRadius: BorderRadius.circular(16),
                              border: Border.all(
                            ...
                            child: Column(
                              children: [
                                Icon(
                                  LucideIcons.wifiOff,
                                  size: 48,
                                  color: context.themeData.colorScheme.error.withValues(alpha: 0.7),
                                ),
                                const SizedBox(height: 16),
                                Text(
                        ...
                        if (!coreData.offlineMode && dataSections.carouselRecommendedTracks.isNotEmpty)
                          Column(
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: CarouselView.weighted(
                                    ...
                                    children: [
                                      ...dataSections.carouselRecommendedTracks.map((model) {
                        ...
                        if (!coreData.offlineMode && dataSections.gridRecommendedTracks.isNotEmpty) ...[
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Padding(
                              ...
                              SizedBox(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemCount: dataSections.gridRecommendedTracks.length,
                                  itemBuilder: (context, index) {
                                    final recommendation = dataSections.gridRecommendedTracks[index];
                                                        ...
                                                        return Padding(
                                                          ...
                                                          child: AlbumItem(
                                                            ...
                                                            onTap: () {
                                                              ...
                                                              libraryController.methods.getLibraryItem(content.id);
                                                            },
                                                          ),
                                                        );
                                                      }
