...
class SectionsData extends BaseControllerData {
  ...
  DateTime? lastDataUpdate; // Cache timestamp
  Duration cacheValidity; // Cache validity duration
  ...
  SectionsData({
    ...
    this.lastDataUpdate,
    this.cacheValidity = const Duration(minutes: 5), // 5 minutos de cache
  });
  ...
  bool get isCacheValid {
    ...
    return DateTime.now().difference(lastDataUpdate!) < cacheValidity;
  }
}
