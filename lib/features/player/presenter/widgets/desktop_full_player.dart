    ...
    return widget.playerController.builder(
      builder: (context, data) {
        ...
        return Container(
          ...
          child: Stack(
            children: [
              // Background with Blur Effect (low-res to keep it light)
              Positioned.fill(
                child: track.lowResImg != null && track.lowResImg!.isNotEmpty
                    ? RepaintBoundary(
                        child: Stack(
                        children: [
                            Positioned.fill(
                            ...
                            // Gradient overlay for contrast and color adaptation
                            Positioned.fill(
                              child: DecoratedBox(
